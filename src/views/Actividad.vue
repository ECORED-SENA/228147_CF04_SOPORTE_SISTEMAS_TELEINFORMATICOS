  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Fortalecer la apropiación de los conceptos sobre las estrategias de gestión de <i>hardware</i> y <i>software</i> con el fin de diferenciar cómo se puede plantear una programación de posibles mantenimientos.
